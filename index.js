...
const { Client, ReactionCollector, MessageEmbed, Permissions } = require('discord.js');
  ...
  if(interaction.isButton()){
    if(interaction.customId === "open-ticket"){
      ...
      interaction.guild.channels.create("ticket-" + nbTicket, {
        parent: config.catégo
      }).then(channel => {

        channel.permissionOverwrites.create(interaction.guild.roles.everyone, { VIEW_CHANNEL: false});
        //channel.permissionOverwrites.create(interaction.guild.roles.member, { VIEW_CHANNEL: true});
        //channel.permissionOverwrites.create(interaction.guild.roles.config.roleadmin, { VIEW_CHANNEL: true});
